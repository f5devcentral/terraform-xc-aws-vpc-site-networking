...
output "outside_subnet_ids" {
  value       = module.aws_vpc.outside_subnet_ids
  description = "The IDs of the outside subnets."
}

output "inside_subnet_ids" {
  value       = module.aws_vpc.inside_subnet_ids
  description = "The IDs of the inside subnets."
}

output "workload_subnet_ids" {
  value       = module.aws_vpc.workload_subnet_ids
...
output "outside_route_table_id" {
  value       = module.aws_vpc.outside_route_table_id
...
output "inside_security_group_id" {
  value       = module.aws_vpc.inside_security_group_id
